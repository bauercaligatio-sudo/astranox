const factions = {
  nyxaren: {
    ...
    image: "assets/images/nyxaren.png",
    audio: "assets/audio/nyxaren.mp3",
    volume: 0.82,
  ...
  terraner: {
    ...
    image: "assets/images/terraner.png",
    audio: "assets/audio/terraner.mp3",
    volume: 1.0,
  ...
  prometheaner: {
    ...
    image: "assets/images/prometheaner.png",
    audio: "assets/audio/prometheaner.mp3",
    volume: 0.84,
  ...
  lykaner: {
    ...
    image: "assets/images/lykaner.png",
    audio: "assets/audio/lykaner.mp3",
    volume: 0.88,
  ...
  orks: {
    ...
    image: "assets/images/orks.png",
    audio: "assets/audio/orks.mp3",
    volume: 0.72,
  ...
  aeldir: {
    ...
    image: "assets/images/aeldir.png",
    audio: "assets/audio/aeldir.mp3",
    volume: 0.9,
...
const theme = { title: "Astranox — Thema", audio: "assets/audio/theme.mp3", volume: 1.0 };
